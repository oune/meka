...
var app = (function () {
    ...
    /* src\component\SensorBlock.svelte generated by Svelte v3.44.3 */

    const { console: console_1 } = globals;
    const file$1 = "src\\component\\SensorBlock.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			option.__value = /*option*/ ctx[15].id;
    			option.value = option.__value;
    			add_location(option, file$1, 112, 16, 2630);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(112:12) {#each options as option}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "수신한 모델 결과가 없습니다.";
    			add_location(p, file$1, 120, 8, 2802);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*model_res*/ ctx[3] == 1) return create_if_block_1;
    		if (/*model_res*/ ctx[3] == -1) return create_if_block_2;
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			if_block1.c();
    			add_location(h20, file$1, 96, 4, 2273);
    			add_location(h21, file$1, 99, 4, 2319);
    			if (/*selected*/ ctx[5] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[9].call(select));
    			add_location(select, file$1, 110, 8, 2517);
    			add_location(form, file$1, 109, 4, 2501);
    			add_location(div, file$1, 95, 0, 2262);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(select, "change", /*select_change*/ ctx[7], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('SensorBlock', slots, []);
    	let { sensorNum } = $$props;
    	let { port } = $$props;
    	...
    	socket.on("model_result", res => {
    		...
    		$$invalidate(3, model_res = predicted);
    		$$invalidate(2, isEmpty = false);
    	...
    	function select_change() {
    		socket.emit("mode", { port: port.toString(), mode: selected });
    		$$invalidate(3, model_res = 0);
    		$$invalidate(2, isEmpty = true);
    	}
    	...
    	const writable_props = ['sensorNum', 'port'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<SensorBlock> was created with unknown prop '${key}'`);
    	});
    	...
    	function chart_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			chartRef = $$value;
    			$$invalidate(1, chartRef);
    		});
    	}

    	$$self.$$set = $$props => {
    		if ('sensorNum' in $$props) $$invalidate(0, sensorNum = $$props.sensorNum);
    		if ('port' in $$props) $$invalidate(8, port = $$props.port);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ('sensorNum' in $$props) $$invalidate(0, sensorNum = $$props.sensorNum);
    		if ('port' in $$props) $$invalidate(8, port = $$props.port);
    		if ('chartRef' in $$props) $$invalidate(1, chartRef = $$props.chartRef);
    		if ('count' in $$props) count = $$props.count;
    		if ('isEmpty' in $$props) $$invalidate(2, isEmpty = $$props.isEmpty);
    		if ('model_res' in $$props) $$invalidate(3, model_res = $$props.model_res);
    ...
    class SensorBlock extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { sensorNum: 0, port: 8 });
    		...
    		if (/*sensorNum*/ ctx[0] === undefined && !('sensorNum' in props)) {
    			console_1.warn("<SensorBlock> was created without expected prop 'sensorNum'");
    		}

    		if (/*port*/ ctx[8] === undefined && !('port' in props)) {
    			console_1.warn("<SensorBlock> was created without expected prop 'port'");
    		}
    	}

    	get sensorNum() {
    		throw new Error("<SensorBlock>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set sensorNum(value) {
    		throw new Error("<SensorBlock>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment(ctx) {
    	...
    	block0 = new SensorBlock({
    			props: { sensorNum: "1", port: "3001" },
    			$$inline: true
    		});

    	block1 = new SensorBlock({
    			props: { sensorNum: "2", port: "3002" },
    			$$inline: true
    		});

    	block2 = new SensorBlock({
    			props: { sensorNum: "3", port: "3003" },
    			$$inline: true
    		});

    	block3 = new SensorBlock({
    			props: { sensorNum: "4", port: "3004" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 7, 4, 126);
    			attr_dev(div, "class", "sensorContainer svelte-fm9ez9");
    			add_location(div, file, 8, 4, 149);
    			add_location(body, file, 6, 0, 115);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Block: SensorBlock });
    	return [];
    }
