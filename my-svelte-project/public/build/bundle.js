...
var app = (function () {
    ...
    const file$1 = "src\\component\\sensor.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 40, 4, 894);
    			add_location(h30, file$1, 43, 4, 940);
    			add_location(h31, file$1, 45, 4, 1018);
    			add_location(button, file$1, 48, 4, 1102);
    			add_location(div, file$1, 39, 0, 883);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
