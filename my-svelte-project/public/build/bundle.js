...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let chart0_props = { data: /*data*/ ctx[3], type: "line" };
    	chart0 = new Base$1({ props: chart0_props, $$inline: true });
    	/*chart0_binding*/ ctx[5](chart0);
    	let chart1_props = { data: /*data*/ ctx[3], type: "line" };
    	chart1 = new Base$1({ props: chart1_props, $$inline: true });
    	/*chart1_binding*/ ctx[6](chart1);

    	const block = {
    		c: function create() {
    			div = element("div");
    			h2 = element("h2");
    			t0 = text(/*sensorNum*/ ctx[2]);
    			t1 = text("번 센서");
    			t2 = space();
    			h30 = element("h3");
    			h30.textContent = "진동";
    			...
    			button.textContent = "Add data point";
    			add_location(h2, file$2, 40, 4, 894);
    			add_location(h30, file$2, 43, 4, 940);
    			add_location(h31, file$2, 45, 4, 1018);
    			add_location(button, file$2, 48, 4, 1102);
    			add_location(div, file$2, 39, 0, 883);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, h31);
    			append_dev(div, t7);
    			mount_component(chart1, div, null);
    			append_dev(div, t8);
    			append_dev(div, button);
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*addDataPoint*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*sensorNum*/ 4) set_data_dev(t0, /*sensorNum*/ ctx[2]);
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			/*chart0_binding*/ ctx[5](null);
    			destroy_component(chart0);
    			/*chart1_binding*/ ctx[6](null);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { chartRefRumble } = $$props;
    	let { charRefTemperature } = $$props;
    	...
    	const writable_props = ['sensorNum', 'chartRefRumble', 'charRefTemperature'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Sensor> was created with unknown prop '${key}'`);
    	});

    	function chart0_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			chartRefRumble = $$value;
    			$$invalidate(0, chartRefRumble);
    		});
    	}

    	function chart1_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			charRefTemperature = $$value;
    			$$invalidate(1, charRefTemperature);
    		});
    	}

    	$$self.$$set = $$props => {
    		if ('sensorNum' in $$props) $$invalidate(2, sensorNum = $$props.sensorNum);
    		if ('chartRefRumble' in $$props) $$invalidate(0, chartRefRumble = $$props.chartRefRumble);
    		if ('charRefTemperature' in $$props) $$invalidate(1, charRefTemperature = $$props.charRefTemperature);
    	};
    ...
    class Sensor extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*chartRefRumble*/ ctx[0] === undefined && !('chartRefRumble' in props)) {
    			console.warn("<Sensor> was created without expected prop 'chartRefRumble'");
    		}

    		if (/*charRefTemperature*/ ctx[1] === undefined && !('charRefTemperature' in props)) {
    			console.warn("<Sensor> was created without expected prop 'charRefTemperature'");
    		}
    	}
    	...
    	set chartRefRumble(value) {
    		throw new Error("<Sensor>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get charRefTemperature() {
    		throw new Error("<Sensor>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set charRefTemperature(value) {
    		throw new Error("<Sensor>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    /* src\component\test.svelte generated by Svelte v3.44.3 */

    const { console: console_1 } = globals;
    const file$1 = "src\\component\\test.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	let chart1;
    	let current;
    	let chart0_props = { data: /*data*/ ctx[2], type: "line" };
    	chart0 = new Base$1({ props: chart0_props, $$inline: true });
    	/*chart0_binding*/ ctx[3](chart0);
    	let chart1_props = { data: /*data*/ ctx[2], type: "line" };
    	chart1 = new Base$1({ props: chart1_props, $$inline: true });
    	/*chart1_binding*/ ctx[4](chart1);
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			create_component(chart1.$$.fragment);
    			add_location(h30, file$1, 45, 4, 1064);
    			add_location(h31, file$1, 47, 4, 1142);
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			/*chart0_binding*/ ctx[3](null);
    			destroy_component(chart0);
    			/*chart1_binding*/ ctx[4](null);
    			destroy_component(chart1);
    		}
    	};
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['chartRefRumble', 'charRefTemperature'];
    	...
    	return [chartRefRumble, charRefTemperature, data, chart0_binding, chart1_binding];
    }

    class Test extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { chartRefRumble: 0, charRefTemperature: 1 });
    		...
    		if (/*chartRefRumble*/ ctx[0] === undefined && !('chartRefRumble' in props)) {
    			console_1.warn("<Test> was created without expected prop 'chartRefRumble'");
    		}

    		if (/*charRefTemperature*/ ctx[1] === undefined && !('charRefTemperature' in props)) {
    			console_1.warn("<Test> was created without expected prop 'charRefTemperature'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(sensor2.$$.fragment);
    			t4 = space();
    			create_component(sensor3.$$.fragment);
    			t5 = space();
    			create_component(test.$$.fragment);
    			add_location(h1, file, 5, 0, 120);
    			attr_dev(div, "class", "sensorContainer svelte-fm9ez9");
    			add_location(div, file, 6, 0, 139);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div, t3);
    			mount_component(sensor2, div, null);
    			append_dev(div, t4);
    			mount_component(sensor3, div, null);
    		...
    		i: function intro(local) {
    			...
    			transition_in(sensor2.$$.fragment, local);
    			transition_in(sensor3.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(sensor2.$$.fragment, local);
    			transition_out(sensor3.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(sensor2);
    			destroy_component(sensor3);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Sensor, Test });
    	return [];
    }
