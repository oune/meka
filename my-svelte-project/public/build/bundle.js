...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 35, 4, 845);
    			add_location(h30, file$1, 38, 4, 891);
    			add_location(h31, file$1, 40, 4, 969);
    			add_location(div, file$1, 34, 0, 834);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Sensor, Demo: Test });
    	return [];
    }
