...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 31, 4, 717);
    			add_location(h30, file$2, 34, 4, 763);
    			add_location(h31, file$2, 36, 4, 841);
    			add_location(div, file$2, 30, 0, 706);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			/*chart0_binding*/ ctx[4](null);
    			destroy_component(chart0);
    			/*chart1_binding*/ ctx[5](null);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['sensorNum'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Sensor> was created with unknown prop '${key}'`);
    	});

    	function chart0_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			chartRefRumble = $$value;
    			$$invalidate(1, chartRefRumble);
    		});
    	}
    	...
    	function chart1_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			...
    			$$invalidate(2, charRefTemperature);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('chartRefRumble' in $$props) $$invalidate(1, chartRefRumble = $$props.chartRefRumble);
    		if ('charRefTemperature' in $$props) $$invalidate(2, charRefTemperature = $$props.charRefTemperature);
    	};
    ...
    class Sensor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { sensorNum: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			create_component(chart1.$$.fragment);
    			add_location(h30, file$1, 27, 4, 649);
    			add_location(h31, file$1, 29, 4, 727);
    			add_location(div, file$1, 26, 0, 638);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	socket.on("data", arg => {
    		chartRefRumble.addDataPoint("label", [arg]);
    		charRefTemperature.addDataPoint("label", [arg]);
    	});
